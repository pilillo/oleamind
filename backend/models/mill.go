...
type OliveDelivery struct {
	...
	Mill            Mill     `json:"mill" gorm:"foreignKey:MillID"`
...
type OilBatchSource struct {
	...
	OilBatch         OilBatch     `json:"oil_batch" gorm:"foreignKey:OilBatchID"`
	OliveDeliveryID  uint         `json:"olive_delivery_id" binding:"required"`
	OliveDelivery    OliveDelivery `json:"olive_delivery" gorm:"foreignKey:OliveDeliveryID"`
